...
class WebsitesController extends Controller
{
    ...
    {     
        ...
        $vars = array(
            ...
            '{BODY}' => "<span id='website' style='display:none'>{$popupObject->website_addr}</span><span style='display:none'>" . Config('path.aspireVersion') . "</span><span id='required_key' style='display:none'>{$websiteKey}</span>{$popupObject->text}",
            ...
            '{ASPIREVERSION}' => Config('path.aspireVersion')
        );
